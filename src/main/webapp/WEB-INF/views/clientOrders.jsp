                ...
                <div class="block__main">
                    ...
                    <form id="formClient" action="${pageContext.request.contextPath}/client-order-list" method="get" class="form-client">
                        <div class="block__type-occupation">
                            <p class="title"><fmt:message key="msg.your_bookings"/>:</p>
                            <div class="block-types">
                                ...
                                <table class="about__table">
                                    <tr class="about__table-tr">
                                        ...
                                        <th class="about__table-td"><fmt:message key="msg.previous"/></th>
                                        <th class="about__table-td"><fmt:message key="msg.days"/></th>
                                        <th class="about__table-td"><fmt:message key="msg.class"/></th>
                                        ...
                                        <tr class="about__table-tr">
                                            ...
                                            <th class="about__table-td">
                                                <c:if test="${order.inConfirmation()}">
                                                    <p>
                                                        <a href="${pageContext.request.contextPath}/client-order-confirm?order=${order.getId()}&room=${order.getRoomId()}&sum=${order.getTotalSum()}"><fmt:message key="msg.confirm"/></a> /
                                                        <a href="${pageContext.request.contextPath}/client-order-cancel?order=${order.getId()}&room=${order.getRoomId()}"><fmt:message key="msg.cancel"/></a>
                                                    </p>
                                                </c:if>
                                            </th>
                                        </tr>
