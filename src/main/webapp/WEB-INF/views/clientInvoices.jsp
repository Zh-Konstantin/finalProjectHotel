                ...
                <div class="block__left">
                    ...
                    <div class="user-menu">
                        <ul class="menu-list">
                            ...
                            <li class="menu-item"><a class="menu-link" href="${pageContext.request.contextPath}/client-order-list"><span
                            ...
                            <li class="menu-item _active"><a class="menu-link" href="${pageContext.request.contextPath}/client-invoice-list"><span class="svg-profile"><svg
