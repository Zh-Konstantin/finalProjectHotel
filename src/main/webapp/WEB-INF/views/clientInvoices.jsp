        ...
        <div class="container">
            <div class="section__wrapper">
                <div class="block__left">
                    ...
                    <div class="user-menu">
                        <ul class="menu-list">
                            <li class="menu-item"><a class="menu-link" href="${pageContext.request.contextPath}/room-pagination"><span class="svg-study"><svg
                            ...
                            <li class="menu-item _active"><a class="menu-link" href="#"><span class="svg-profile"><svg
                ...
                <div class="block__main">
                    ...
                    <form id="formClient" action="${pageContext.request.contextPath}/room-booking" method="post" class="form-client">
                        <div class="block__type-occupation">
                            <p class="title">Ваши счета на оплату</p>
                            <div class="block-types">


                                сделать шапку таблицы
                                <c:forEach items="${invoices}" var="invoice">
                                    прописать вывод каждой графы таблицы с кнопкой "оплатить" или "отменить" если paid=false
                                </c:forEach>
                            ...
                            <div class="button-wrapper">
                                ...
                                <button type="submit" class="button">Оплатить счет</button>
                            </div>
