        ...
        <div class="container">
            <div class="section__wrapper">
                            ...
                            <button type="button" class="user-button">
                                <span class="svg-arrow">
                                    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 16 16">
                                        <path d="M5 15c-.3 0-.5-.1-.7-.3-.4-.4-.4-1 0-1.4L9.6 8 4.3 2.7c-.4-.4-.4-1 0-1.4s1-.4 1.4 0l6 6c.4.4.4 1 0 1.4l-6 6c-.2.2-.4.3-.7.3z"></path>
                                    </svg>
                                </span>
                            </button>
                        </div>
                ...
                <div class="block__main">
                    ...
                    <form id="formClient" action="${pageContext.request.contextPath}/client-invoice-list" method="get" class="form-client">
                        <div class="block__type-occupation">
                            <p class="title"><fmt:message key="msg.your_invoices"/></p>
                            <div class="block-types">

                                <table class="about__table">
                                    <tr class="about__table-tr">
                                        <th class="about__table-td"><fmt:message key="msg.id"/></th>
                                        <th class="about__table-td"><fmt:message key="msg.date"/></th>
                                        <th class="about__table-td"><fmt:message key="msg.room_num"/></th>
                                        <th class="about__table-td"><fmt:message key="msg.sum"/></th>
                                        <th class="about__table-td"><fmt:message key="msg.status"/></th>
                                        <th class="about__table-td"><fmt:message key="msg.confirm_cancel"/></th>
                                    </tr>
                                        ...
                                        <tr class="about__table-tr">
                                            ...
                                            <th class="about__table-td">
                                                <c:if test="${invoice.isPendingPayment()}">
                                                    <p>
                                                        <a href="${pageContext.request.contextPath}/client-invoice-payment?invoice=${invoice.getId()}&room=${invoice.getRoomId()}&order=${invoice.getOrderId()}"><fmt:message key="msg.pay"/></a> /
                                                        <a href="${pageContext.request.contextPath}/client-invoice-refusal?invoice=${invoice.getId()}&room=${invoice.getRoomId()}&order=${invoice.getOrderId()}"><fmt:message key="msg.refuse"/></a>
                                                    </p>
                                                </c:if>
                                            </th>
                                        </tr>
                            ...
                            <div class="button-wrapper">
                                <button type="submit" class="button"><fmt:message key="msg.refresh"/></button>
                            </div>
                        </div>
                    </form>
