 ...
 */
public class ClientInvoiceRefusalServlet extends HttpServlet {
    ...
    /**
     * Method that implements the invoice rejection process
    ...
    private void processRequest(HttpServletRequest req, HttpServletResponse resp) throws IOException {
        ...
        if (invoiceId != null && !invoiceId.isEmpty()) {
            ...
            invoiceService.refreshStatus(Integer.parseInt(invoiceId), InvoiceStatus.REJECTED.getName());
        }

        if (roomId != null && !roomId.isEmpty()) {
            RoomService roomService = new RoomService();
            roomService.refreshStatus(Integer.parseInt(roomId), RoomStatus.FREE.getName());
        }

        if (orderId != null && !orderId.isEmpty()) {
            OrderService orderService = new OrderService();
            orderService.refreshStatus(Integer.parseInt(orderId), OrderStatus.CANCELED.getName());
        }
